...
This looks like pretty standard swagger docs based on the spec found here: https://github.com/OAI/OpenAPI-Specification/blob/master/versions/1.2.md. New Relic has documented all of of their resources and operations in html using the `notes` property. We should be able to translate these values to godoc code comments.
